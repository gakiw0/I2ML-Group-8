...
The behavior classification checkpoint is not stored in this GitHub repository due to file size. Download it from:
...
If you use a different file name, set `BD_CKPT_FILE` to match (see Configuration).
...
Note: third-party dependencies, datasets, and downloaded model weights may have their own licenses/terms and are not necessarily covered by the MIT License for this repository.
